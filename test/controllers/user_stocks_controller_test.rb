...
class UserStocksControllerTest < ActionController::TestCase
  ...
  test "should create user_stock" do
    assert_difference('UserStock.count') do
      post :create, user_stock: { stock_id: @user_stock.stock_id, stock_rss_feed: @user_stock.stock_rss_feed, user_id: @user_stock.user_id }
    end
  ...
  test "should update user_stock" do
    patch :update, id: @user_stock, user_stock: { stock_id: @user_stock.stock_id, stock_rss_feed: @user_stock.stock_rss_feed, user_id: @user_stock.user_id }
    assert_redirected_to user_stock_path(assigns(:user_stock))
  end
